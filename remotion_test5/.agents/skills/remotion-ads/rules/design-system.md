...
const COLORS = {
  // Primary colors
  primary: "#be4949",           // TODO: Your main brand color
  primaryLight: "#2e5b2f",      // TODO: Lighter variant
  primaryDark: "#1a4234",       // TODO: Darker variant
  ...
  // Backgrounds
  background: "#b397e3",        // TODO: Light background
  backgroundDark: "#252739",    // TODO: Darker background variant
...
const LOGO_PATH = "download.png";  // In public/ folder
```
...
const BRAND_NAME = "Nova Cart";
const BRAND_TAGLINE = "Cart with nNova Now";
```
